...
./UDKGameServer-Linux AOCFFA-Moor_p\?steamsockets\?Port=8000\?QueryPort=27015\?adminpassword=${ADMIN_PW}\?password=${GAME_PW} -sdkfileid=248639339 -seekfreeloadingserver